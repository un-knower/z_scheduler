...
public class BatchServlet extends HttpServlet {
	...
	private Batch getBeanFromReqeust(HttpServletRequest req){
		...
		b.setEnddate(ifNullBlank(req.getParameter("enddate")));
		b.setFlag(Integer.parseInt(req.getParameter("flag")));
		b.setBname(ifNullBlank(req.getParameter("bname")));
		b.setStartdate(ifNullBlank(req.getParameter("startdate")));
		b.setEnddate(ifNullBlank(req.getParameter("enddate")));
		b.setTaskdate(ifNullBlank(req.getParameter("taskdate")));
		b.setTimeinterval(Integer.parseInt(req.getParameter("timeinterval")));
