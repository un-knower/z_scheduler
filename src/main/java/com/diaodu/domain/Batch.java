...
//	if( flag==0失效状态 1可执行状态2完成状态)
	...
	public String toString() {
		return "Batch [id=" + id + ", bname=" + bname + ", bdesc=" + bdesc + ", beforeid=" + beforeid + ", afterid="
				+ afterid + ", taskdate=" + taskdate + ", starttime=" + starttime + ", flag=" + flag + ", status="
				+ status + ", timeinterval=" + timeinterval + ", startdate=" + startdate + ", enddate=" + enddate
				+ ", btype=" + btype + ", nextexecutetime=" + nextexecutetime + ", threadcount=" + threadcount + "]";
	}
